...
declare -A MENU_ITEMS=(
  ...
  [6]="Debian 13 (Trixie)|linux/debian/13"
  [7]="Debian 12 (Bookworm)|linux/debian/12"
  [8]="Debian 11 (Bullseye)|linux/debian/11"
  [9]="openSUSE Leap 15.6|linux/opensuse/leap-15-6"
  [10]="openSUSE Leap 15.5|linux/opensuse/leap-15-5"
  [11]="Oracle Linux 9|linux/oracle/9"
  [12]="Oracle Linux 8|linux/oracle/8"
  [13]="Rocky Linux 10|linux/rocky/10"
  [14]="Rocky Linux 9|linux/rocky/9"
  [15]="Rocky Linux 8|linux/rocky/8"
  [16]="Ubuntu Server 25.04|linux/ubuntu/25-04"
  [17]="Ubuntu Server 24.04 LTS|linux/ubuntu/24-04-lts"
  [18]="Ubuntu Server 22.04 LTS|linux/ubuntu/22-04-lts"
  [19]="Ubuntu Server 20.04 LTS|linux/ubuntu/20-04-lts"
  [20]="Windows 11 - All|windows/desktop/11|"
  [21]="Windows 11 - Enterprise|windows/desktop/11|--only proxmox-iso.windows-desktop-ent"
  [22]="Windows 11 - Professional|windows/desktop/11|--only proxmox-iso.windows-desktop-pro"
  [I]="Information|info"
  [Q]="Quit|quit_program"
)
